  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <Button
        ...
        className={
          value === "buy"
            ? "bg-linear-to-br from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white shadow-lg shadow-green-600/20 border-green-500/50"
      ...
      <Button
        ...
        className={
          value === "sell"
            ? "bg-linear-to-br from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white shadow-lg shadow-red-600/20 border-red-500/50"
